import rabbitMQClient from "./RabbitMQClient"; // Import the RabbitMQ client
import { RoutingKeys } from "./settings/routingKeys"; // Import routing keys
import Message from "./settings/messageTemplate"; // Import the Message class
